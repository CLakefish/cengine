...
inline vec3_t vec3_Mult(const vec3_t a, const float scalar) {
	return (vec3_t) { a.x * scalar, a.y * scalar, a.z * scalar };
}

inline vec3_t vec3_Div(const vec3_t a, const float scalar) {
	return (vec3_t) { a.x / scalar, a.y / scalar, a.z / scalar };
}

inline float vec3_Mag(const vec3_t a) {
...
inline vec3_t vec3_Normalized(const vec3_t t) {
...
inline vec3_t vec3_Cross(const vec3_t a, const vec3_t b) {
	return (vec3_t) { (a.y * b.z) - (a.z * b.y), (a.z * b.x) - (a.x * b.y), (a.x * b.y) - (a.y * b.x) };
}

inline vec3_t vec3_Lerp(const vec3_t a, const vec3_t b, const float t) {
...
inline float vec3_SignedAngle(const vec3_t a, const vec3_t b, const vec3_t n) {
...
inline void vec3_Print(const vec3_t a) {
